...
```{bash}
head ./output/out_hgmm1k_v3/output.sorted.txt
```
...
The first PC separates species, as expected. Here the 2 mixed species "cells" seem to be more similar to human cells than mouse cells.
```{r tsne}
