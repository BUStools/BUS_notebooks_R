...
We will not get into the details of how to make the `bus` file with `kallisto bus` and `bustools`, as the data will be downloaded with `TENxBUSData`.
```{r}
TENxBUSData("./output", dataset = "pbmc1k")
```
