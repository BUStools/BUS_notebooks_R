...
There about about 737K valid cell barcodes.
...
### Seurat exploration
Note: [Seurat 3.0](https://github.com/satijalab/seurat/tree/release/3.0), which is not yet oon CRAN, is used in this notebook.
```{r}
